...
def get_leave_data(employee):
    ...
    leave_data = frappe.db.get_list('Leave Application',fields = ["name"],filters=[['name','not in',joining_array],['status','in',["Approved","Amended"]],["employee","=",employee],['leave_type','not in',['Casual Leave']]])
